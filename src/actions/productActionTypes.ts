export enum productActionType {
  ...
  PRODUCT_PRODUCT_TOP_REQUEST = 'PRODUCT_PRODUCT_TOP_REQUEST',
  PRODUCT_PRODUCT_TOP_SUCCESS = 'PRODUCT_PRODUCT_TOP_SUCCESS',
  PRODUCT_PRODUCT_TOP_FAIL = 'PRODUCT_PRODUCT_TOP_FAIL',
}
