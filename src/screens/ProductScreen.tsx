...
interface reduxState {
  ...
  productCreateReview: { loading: boolean; success: boolean; error: string };
  userLogin: { userInfo: { name: string } };
}
...
const ProductScreen = ({ history, match }: props) => {
  ...
  const { productDetails, productCreateReview, userLogin } = useSelector(
